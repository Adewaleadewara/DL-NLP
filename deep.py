...
st.markdown("<h1 style = 'color: #272727; text-align: center; font-family:Lucida Bright'>TEXT TO SPEECH CHATBOT</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #140303; text-align: center; font-family: Monaco'> Built by ADEWALE A.J </h4>", unsafe_allow_html = True)
...
with robot_image:
    robot_image.image('pngwing.com (18).png',width = 500, caption = 'I reply all your questions')
